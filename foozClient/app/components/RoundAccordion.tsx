...
export const RoundAccordion = ({ round }: Props) => {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute top-full -mt-1 z-10 bg-lime-700 rounded left-0 right-0 py-2 border border-slate-100/10 border-t-0 rounded-tl-none rounded-tr-none -mx-[1px] max-h-64 overflow-y-auto">
